...
test.describe('Episode Link Focus Visibility', () => {
  test('episode links should have highly visible focus indicators in light mode', async ({
    page,
  }) => {
  ...
  test('episode links should have highly visible focus indicators in dark mode', async ({
    page,
  }) => {
    await page.goto('/episodes/')
    await page.waitForLoadState('networkidle')
    ...
    // Log the actual color for debugging
    console.log(
      'Dark mode episode link focus outline color:',
      styles.outlineColor
    )
    console.log('Dark mode episode link background:', styles.backgroundColor)
  })

  test('episode links on home page should have visible focus indicators', async ({
    page,
  }) => {
    await page.goto('/')
    await page.waitForLoadState('networkidle')
